...
- At the bottom of the list, **a link to the Xbox tasks**. The app and the console run their own daily, weekly and monthly tasks, and their points appear neither in this panel nor in the Rewards dashboard, because they credit from Xbox itself — the tooltip says so, and the link goes to the Xbox page, served already translated for your market.
...
- Debajo de los controles el panel lista **lo que Rewards te pide hoy aparte de buscar**: una línea por cada socio del check-in con el paso en el que va y lo que paga el último (buscar con Bing, el conjunto diario, el registro en la app de Bing, explorar con Edge, Outlook, MSN…), encabezadas por el contador de tu jornada y por el puzle de sellos con lo que da completarlo.
- **Cada una de esas líneas es una escalera de siete pasos, y el séptimo da el premio gordo**: 120 puntos en Edge y 100 en casi todos los demás. Entre los siete socios son 1203 puntos por semana, y 670 de ellos —el 56%— están solo en los séptimos pasos. Completar una gana un sello del puzle, así que un sello que parece faltar suele ser una escalera a medio recorrer y no un sello perdido. Por eso el paso y el premio van delante de la etiqueta: el final de la línea es lo primero que se recorta.
...
- Al final de la lista, **un enlace a las tareas de Xbox**. La app y la consola tienen sus propias diarias, semanales y mensuales, y sus puntos no salen ni en este panel ni en el de Rewards porque se acreditan desde Xbox —el aviso lo explica, y el enlace lleva a la página de Xbox, que se sirve ya traducida a tu mercado—.
