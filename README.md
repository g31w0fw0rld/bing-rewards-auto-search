...
- **The tooltip on the day's points says how much this panel can actually measure.** It adds up the searches, the daily set and the loose offers — everything with a points figure of its own — and leaves out the streak steps, which are the one term it cannot tell apart. So it is a floor, not a ceiling: going over it means you have done activities it cannot see.
...
- **El aviso de los puntos del día dice cuánto sabe medir de verdad este panel.** Suma las búsquedas, el conjunto diario y las ofertas sueltas —todo lo que tiene una cifra de puntos propia— y deja fuera los pasos de las escaleras, que son el único término que no puede separar. Así que es un suelo y no un techo: pasarlo significa que has hecho actividades que no ve.
