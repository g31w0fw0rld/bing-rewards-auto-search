...
- **Each of those lines is a seven-step ladder, and the seventh pays the big one** — 100 points for search and the daily set, 50 for the app, 120 for Edge. Completing one earns a stamp towards the puzzle, so a stamp that seems to be missing is usually a ladder still on its way, not a stamp lost. That is why the step and the prize come before the label: the end of the line is what gets clipped first.
